...
def run_test_factorial():
    ...
    # -------------------------------------------------------------------------
    expected = [math.factorial(30), math.factorial(45), 720]
    answer = [factorial(30), factorial(45), factorial(6)]
    for i in range(3):
        print('Test', i + 3, 'expected (from oracle):', expected[i])
        print('       actual (from my code): ', answer[i])
...
def run_test_count_cosines_from():
    ...
    # -------------------------------------------------------------------------
    expectedList = [0, 3, 3, 4, 2]
    answers = [count_cosines_from(3, 5, 0.7), count_cosines_from(4, 8, 0), count_cosines_from(6, 9, -0.2), count_cosines_from(3, 9, -0.6), count_cosines_from(5, 7, 0.3)]
    for i in range(5):
        print('Test', i + 2, 'expected:', expectedList[i])
...
def run_test_sum_unit_fractions_from():
    ...
    # -------------------------------------------------------------------------
    expectedList = [0.50952380952380952381, 1.71785714285714285714]
    answers = [sum_unit_fractions_from(5, 7), sum_unit_fractions_from(2, 8)]
    for i in range(2):
        print('Test', i + 2, 'expected:', expectedList[i], '(approximately)')
        print('       actual:  ', answers[i])
