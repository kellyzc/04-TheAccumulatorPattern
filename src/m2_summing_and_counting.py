...
def run_test_sum_more_cosines():
    ...
    # -------------------------------------------------------------------------
    expectedList = [-2.05978295401119975891, 0.67446527858869159053]
    answers = [sum_more_cosines(2, 4), sum_more_cosines(-1, 3)]
    for i in range(2):
        print('Test', i + 2, 'expected:', expectedList[i], '(approximately)')
        if answers[i] is not None:
            print('       actual:  ', round(answers[i], 5))
        else:
...
def run_test_count_sines_from():
    ...
    # -------------------------------------------------------------------------
    expectedList = [4, 3, 2, 1, 4]
    answers = [count_sines_from(4, 9), count_sines_from(4, 6), count_sines_from(5, 7), count_sines_from(8, 9), count_sines_from(3, 8)]
    for i in range(5):
...
def run_test_count_sines_vs_cosines():
    ...
    # Below this comment, add 5 more test cases of your own choosing.
    # -------------------------------------------------------------------------
    expectedList = [1, 2, 4, 5, 6]
    answers = [count_sines_vs_cosines(1), count_sines_vs_cosines(2), count_sines_vs_cosines(3), count_sines_vs_cosines(4), count_sines_vs_cosines(5)]
    for i in range(5):
        print('Test', i + 2, 'expected:', expectedList[i])
        if answers[i] is not None:
            print('       actual:  ', round(answers[i], 5))
